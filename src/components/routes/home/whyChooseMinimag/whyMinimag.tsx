...
const WhyMinimag = () => {
  return (
    <WhyMinimagWrapper className="max-w-[1400px] p-4 mx-auto py-16 justify-between gap-[5vw] lg:px-8 lg:gap-[4vw] md:flex">
      <div className="md:w-[35%]">
        ...
        <p className="mt-4">
          ...
          would see out there with not just the shortening feature but also with
          additional feature like getting all previous links you have shortened
          with their respective short links.
        </p>
      </div>
