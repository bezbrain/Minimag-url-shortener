...
const PriceCard = ({
  ...
  return (
    <div className="w-full p-2 rounded-md cursor-pointer border-2 border-[#bdd3f4cc] px-[2vw] lg:hover:scale-[1.20] iPad:hover:scale-[1.10] md:hover:scale-[1.10] iPad:px-10 md:hover:bg-[#1E3448] md:hover:border-0 md:hover:text-white transition-transform surfaceDuo:w-fit surfaceDuo:pt-4 surfaceDuo:pb-8">
      <p>{type}</p>
