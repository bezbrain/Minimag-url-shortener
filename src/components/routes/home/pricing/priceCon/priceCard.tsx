...
const PriceCard = ({
  ...
  return (
    <div className="w-full pt-4 pb-8 rounded-md cursor-pointer border-2 border-[#bdd3f4cc] px-[2vw] iPad:hover:scale-[1.20] iPad:px-12 md:hover:scale-[1.10] md:hover:bg-[#1E3448] md:hover:border-0 md:hover:text-white transition-transform surfaceDuo:w-fit">
      <p>{type}</p>
